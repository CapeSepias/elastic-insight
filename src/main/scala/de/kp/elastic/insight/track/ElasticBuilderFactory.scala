...
object ElasticBuilderFactory {
  ...
  def getSource(builder:String,params:Map[String,Any]):java.util.Map[String,Object] = {
  ...
  def getFields(builder:String,params:Map[String,Any]):(List[String],List[String]) = {
