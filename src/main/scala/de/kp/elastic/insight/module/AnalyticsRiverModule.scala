package de.kp.elastic.insight.module
...
import de.kp.elastic.insight.river.AnalyticsRiver

class AnalyticsRiverModule extends AbstractModule {

  override protected def configure() {
    bind(classOf[River]).to(classOf[AnalyticsRiver]).asEagerSingleton()
  }
