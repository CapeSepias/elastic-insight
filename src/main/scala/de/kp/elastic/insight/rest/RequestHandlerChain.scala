...
class RequestHandlerChain(val handlers:Array[RequestHandler]) {

  var position:Int = 0

  def execute(params:Params, listener:OnErrorListener,requestMap:Map[String,Any],paramMap:HashMap[String,Any]) {
